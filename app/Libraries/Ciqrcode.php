...
class Ciqrcode
{
	...
	function __construct($config = array()) {
		...
		include dirname(__FILE__)."/qrcode/qrconst.php";
		include dirname(__FILE__)."/qrcode/qrtools.php";
		include dirname(__FILE__)."/qrcode/qrspec.php";
		include dirname(__FILE__)."/qrcode/qrimage.php";
		include dirname(__FILE__)."/qrcode/qrinput.php";
		include dirname(__FILE__)."/qrcode/qrbitstream.php";
		include dirname(__FILE__)."/qrcode/qrsplit.php";
		include dirname(__FILE__)."/qrcode/qrrscode.php";
		include dirname(__FILE__)."/qrcode/qrmask.php";
		include dirname(__FILE__)."/qrcode/qrencode.php";
