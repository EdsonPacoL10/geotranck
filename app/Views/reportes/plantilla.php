    ...
    <header>
        <table border="0" width="100%">
            <tr style="text-align: center;">
                <td width="20%">
                    <img src="data:image/png;base64,<?php echo $imagColegio ?>" alt="Escudo Centro Educativo Mutual La Paz"
                        width="100" height="100">
                </td>
                <td width="60%">
                    <h2 style="color: #000;">COOPERATIVA EDUCACIONAL "EL KENKO" R.L.</h2>
                    <h6 style="color: #000;">CENTRO EDUCATIVO "MUTUAL LA PAZ" <br>SIE-40730090 R.M. 2657<br>DISTRITO EL ALTO-2  </h6>
                    
                </td>
                <td width="20%">
                    <img src="data:image/png;base64,<?php echo $imagElAlto ?>" alt="Escudo de El Alto" width="100" height="100">
                </td>
            </tr>
        </table>
    </header>
