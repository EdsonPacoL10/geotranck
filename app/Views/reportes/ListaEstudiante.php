...
<body>
    ...
    <main>
        <div id="titulo2">
            <div class="big-size">Reporte de los Estudiantes Registrados</div>
        </div>
        <div id="contenido">
                ...
                <tbody>
                    ...
                    <?php foreach ($datosEstudiante as $dato): ?>
                        <tr>
                            ...
                            <td width="15%"><?= esc($dato['codigo']) ?></td>
                            <td width="30%"><?= esc($dato['nombre']) ?> <?= esc($dato['apellido']) ?> <br> <b>C.I:. </b><?= esc($dato['ci']) ?><br><b>Edad: </b><?= esc($dato['edad']) ?></td>
                            <td width="15%"><?= esc($dato['nombretutor']) ?> <?= esc($dato['apellidotutor']) ?></td>
                            <td width="15%"><?= esc($dato['telefonotutor']) ?></td>
                            <td width="15%"><?= esc($dato['parentesco']) ?></td>
