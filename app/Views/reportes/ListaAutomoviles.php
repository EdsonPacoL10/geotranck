    ...
    <main>
        ...
        <?php if (!empty($datosAutomovil)): ?>
            <table border="1" class="styled-table">
                ...
                <tbody>
                    <?php $contador = 1; ?>
                    <?php foreach ($datosAutomovil as $dato): ?>
                        <tr>
                            <td width="5%"><?= $contador++ ?></td>
                            <td width="15%"><b>Marca:.</b> <?= esc($dato['marca']) ?> <br> <b>Modelo:.</b><?= esc($dato['modelo']) ?><br>Color:. <?= esc($dato['color']) ?></td>
                            <td width="15%"><b>Placa:.</b><?= esc($dato['placa']) ?> <br><b>Tipo:.</b> <?= esc($dato['tipovehiculo']) ?><br><b>Pasajeros:.</b> <?= esc($dato['nropasajeros']) ?></td>
                            <td width="30%"><?= esc($dato['nombreconductor']) ?> <?= esc($dato['apellidoconductor']) ?></td>
                            <td width="15%"><b>C.I:.</b><?= esc($dato['ci']) ?> <b>Telefono:.</b><?= esc($dato['telefono']) ?></td>
                            <td width="15%"><?= esc($dato['direccion']) ?></td>
