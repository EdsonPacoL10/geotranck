											...
											<div class="mb-5">
												...
												<a class="custom-list d-flex align-items-center px-5 ">
													...
													<div class="d-flex flex-column flex-grow-1 mx-5">
														...
														<!--begin::Link-->
														<span class="text-gray-400 fw-bold"><?= $estudiante['nombretutor'] ?>
															<?= $estudiante['apellidotutor'] ?></span>
														<span class="text-gray-400 fw-bold"><?= $estudiante['telefonotutor'] ?>
														</span>
														<!--end::Link-->
													</div>
													<!--begin::Description-->
								...
								<div id="kt_aside_menu_wrapper" class="menu-fit">
									...
									<div class="menu-item pt-5">
										...
										<div class="menu-content">
											<span class="menu-heading fw-bold text-uppercase fs-7">Gestion de
												Usuario</span>
										</div>
										<!--end:Menu content-->
									</div>
									...
									<div class="menu-item pt-5">
										<!--begin:Menu content-->
										<div class="menu-content">
											<span class="menu-heading fw-bold text-uppercase fs-7">Gestion del
												transporte</span>
										</div>
										<!--end:Menu content-->
									</div>
						...
						<div class="tab-pane fade" id="kt_aside_nav_tab_authors" role="tabpanel">
							...
							<div class="mx-5">
								...
								<div class="alert alert-primary d-flex align-items-center" role="alert">
									...
									<div>
										Sector donde se encuentra un resumen del estados de los dispositivos de
										seguridad en los automoviles
									</div>
								</div>
								<!--begin::Body-->
								<div class="mb-12">
