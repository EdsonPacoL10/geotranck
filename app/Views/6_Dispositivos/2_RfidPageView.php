    ...
    <div class="card">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-600px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header" id="kt_modal_add_customer_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bold">Nuevo Dispositivo RFID</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                                <div id="kt_modal_RFID_close" class="btn btn-icon btn-sm btn-active-icon-primary">
                                ...
                                <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" data-validacion="^[a-zA-Z0-9\s\-]*$"
                                            ...
                                            placeholder="Ingrese la marca del dispositivo..." id="marca" />
                                        <!--end::Input-->
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" data-validacion="^[a-zA-Z0-9\s\-]*$"
                                            class="form-control form-control-solid validar"
                                            placeholder="Ingrese el modelo o tipo del dispositivo..." id="modelo" />
                                        <!--end::Input-->
                                        ...
                                        <div class="col-lg-8 fv-row">
                                            <select id="movilidad" aria-label="Select a Country"
                                                ...
                                                <?php foreach ($datos as $value): ?>
                                                    <option value="<?php echo $value['id'] ?>">Nro.:
                                                        <?php echo $value['placa'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        <!--end::Col-->
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <textarea class="form-control form-control-solid validar"
                            ...
                            <div class="modal-footer flex-center">
                                <!--begin::Button-->
                                <button type="reset" id="kt_modal_RFID_cancelar"
                                    class="btn btn-light me-3">Cancelar</button>
                                <!--end::Button-->
                                <!--begin::Button-->
                                <button type="button" class="btn btn-primary" id="submitBtnRFID">
                ...
                <!--end::Modal - RFID - adicionar-->
                <!-------------------------------------------------------------------------------------------------------------
                  begin::Modal - editar RFID
                --------------------------------------------------------------------------------------------------------------->
                <!--begin::Modal - editar RFID-->
                <div class="modal fade" id="kt_modal_RFID_Edit" tabindex="-1" aria-hidden="true">
                    <!--begin::Modal dialog-->
                    <div class="modal-dialog modal-dialog-centered mw-600px">
                        <!--begin::Modal content-->
                        <div class="modal-content">
                            ...
                            <div class="modal-header" id="kt_modal_add_customer_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bold">Editar Dispositivo RFID</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                                <div id="kt_modal_RFID_Edit_close" class="btn btn-icon btn-sm btn-active-icon-primary">
                                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                                    <span class="svg-icon svg-icon-1">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="modal-body py-2 px-lg-17">
                                ...
                                <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" data-validacion="^[a-zA-Z0-9\s\-]*$"
                                            class="form-control form-control-solid validar"
                                            placeholder="Ingrese la marca del dispositivo..." id="marcaEdit" />
                                        <!--end::Input-->
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" data-validacion="^[a-zA-Z0-9\s\-]*$"
                                            class="form-control form-control-solid validar"
                                            placeholder="Ingrese el modelo o tipo del dispositivo..." id="modeloEdit" />
                                        <!--end::Input-->
                            ...
                            <div class="modal-footer flex-center">
                                <!--begin::Button-->
                                <button type="reset" id="kt_modal_RFID_cancelar_Edit"
                                    class="btn btn-light me-3">Cancelar</button>
                                <!--end::Button-->
                                <!--begin::Button-->
                                <button type="button" class="btn btn-primary" id="submitBtnRFIDEdit">
                                    <span class="indicator-label">Enviar</span>
                                    </span>
                                </button> <!--end::Button-->
                            </div>
            ...
            <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed mb-9 p-6">
                ...
                <div class="d-flex flex-stack flex-grow-1">
                    ...
                    <div class="fw-semibold">
                        <div class="fs-6 text-gray-700">Sector se realiza el registro e informacion del dispositivo RFID
