						...
						<div class="tab-pane fade" id="kt_aside_nav_tab_projects" role="tabpanel">
							...
							<div class="m-0">
								...
								<div class="m-0">
									...
									<div>
										Sector del sistema donde se desplegara la lista de los estudiantes rastreados 
									</div>
									</div>
									<!--end::Description-->
									<!--begin::Items-->
								...
								<div id="kt_aside_menu_wrapper" class="menu-fit">
									...
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion here show">
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link <?php echo ($activeE == 'activeE') ? "active" : ""; ?> "
													href="/gucev">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link <?php echo ($activeP == 'activeP') ? "active" : ""; ?>"
													href="/gucpv">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link <?php echo ($activeA == 'activeA') ? "active" : ""; ?>"
													href="/gucav">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
