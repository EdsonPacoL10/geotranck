...
<html lang="en">
	...
	<!--begin::Body-->
	<body data-kt-name="metronic" id="kt_body" style="background-image: url()" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-enabled">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div id="kt_aside" class="aside aside-extended" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="auto" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
					...
					<div class="aside-primary d-flex flex-column align-items-lg-center flex-row-auto">
						...
						<div class="aside-logo d-none d-lg-flex flex-column align-items-center flex-column-auto py-10" id="kt_aside_logo">
							<a href="../../demo7/dist/index.html">
								<img alt="Logo" src="recursos/metronic/assets/media/logos/demo7.svg" class="h-35px" />
							</a>
						</div>
						<!--end::Logo-->
						<!--begin::Nav-->
											...
											<div class="m-0">
												...
												<div class="d-flex mb-10">
													...
													<div class="flex-shrink-0 ms-2">
														...
														<!--begin::Menu-->
														<!--begin::Menu 1-->
														<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_62c3ffae83b2a">
															<!--begin::Header-->
															<div class="px-7 py-5">
															...
															<div class="px-7 py-5">
																...
																<div class="mb-10">
																	...
																	<!--begin::Input-->
																	<div>
																		<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_62c3ffae83b2a" data-allow-clear="true">
																			<option></option>
										...
										<div class="tab-pane fade" id="kt_aside_nav_tab_menu" role="tabpanel">
											...
											<div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-semibold fs-5 px-6 my-5 my-lg-0" id="kt_aside_menu" data-kt-menu="true">
												<div id="kt_aside_menu_wrapper" class="menu-fit">
														...
														<div class="menu-sub menu-sub-accordion">
															...
															<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
																...
																<div class="menu-sub menu-sub-accordion menu-active-bg">
																	...
																	<div class="menu-item">
																		<!--begin:Menu link-->
																		<a class="menu-link" href="../../demo7/dist/authentication/email/reset-password.html" target="blank">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
																			<span class="menu-title">Reset Password</span>
													...
													<div class="menu-item">
														<!--begin:Menu link-->
														<a class="menu-link" href="../../demo7/dist/documentation/getting-started.html">
															<span class="menu-icon">
																<!--begin::Svg Icon | path: icons/duotune/abstract/abs027.svg-->
																<span class="svg-icon svg-icon-2">
																	<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<!--end::Secondary-->
					<!--begin::Aside Toggle-->
					<button id="kt_aside_toggle" class="btn btn-sm btn-icon bg-body btn-color-gray-700 btn-active-primary position-absolute translate-middle start-100 end-0 bottom-0 shadow-sm d-none d-lg-flex mb-5" data-kt-toggle="true" data-kt-toggle-state="active" data-kt-toggle-target="body" data-kt-toggle-name="aside-minimize">
					...
					<div id="kt_help_scroll" class="hover-scroll-overlay-y" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_help_body" data-kt-scroll-dependencies="#kt_help_header" data-kt-scroll-offset="5px">
						...
						<div class="d-flex align-items-center mb-7">
							...
							<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
								...
								<div class="d-flex flex-column me-2 me-lg-5">
									<!--begin::Title-->
									<a href="../../demo7/dist/documentation/getting-started.html" class="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">Documentation &amp; Videos</a>
									<!--end::Title-->
									<!--begin::Description-->
						...
						<div class="d-flex align-items-center mb-7">
							...
							<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
								...
								<div class="d-flex flex-column me-2 me-lg-5">
									<!--begin::Title-->
									<a href="../../demo7/dist/documentation/base/utilities.html" class="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">Plugins &amp; Components</a>
									<!--end::Title-->
									<!--begin::Description-->
						...
						<div class="d-flex align-items-center mb-7">
							...
							<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
								...
								<div class="d-flex flex-column me-2 me-lg-5">
									<!--begin::Title-->
									<a href="https://preview.keenthemes.com/metronic8/demo7/layout-builder.html" class="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">Layout Builder</a>
									<!--end::Title-->
									<!--begin::Description-->
						...
						<div class="d-flex align-items-center mb-7">
							...
							<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
								...
								<div class="d-flex flex-column me-2 me-lg-5">
									<!--begin::Title-->
									<a href="../../demo7/dist/documentation/getting-started/changelog.html" class="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">What's New</a>
									<!--end::Title-->
									<!--begin::Description-->
		...
		<script src="./recursos/metronic/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
		...
		<script src="./recursos/metronic/assets/js/widgets.bundle.js"></script>
		<script src="./recursos/metronic/assets/js/custom/widgets.js"></script>
		<script src="./recursos/metronic/assets/js/custom/apps/chat/chat.js"></script>
		<script src="./recursos/metronic/assets/js/custom/utilities/modals/upgrade-plan.js"></script>
		<script src="./recursos/metronic/assets/js/custom/utilities/modals/create-app.js"></script>
		<script src="./recursos/metronic/assets/js/custom/utilities/modals/users-search.js"></script>
