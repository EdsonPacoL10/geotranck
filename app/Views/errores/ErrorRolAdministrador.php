...
<html lang="en">
	...
	<body data-kt-name="metronic" id="kt_body" class="app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
		...
		<div class="d-flex flex-column flex-root">
			<!--begin::Page bg image-->
			<style>body { background-image: url('recursos/metronic/assets/media/auth/bg1.jpg'); } [data-theme="dark"] body { background-image: url('recursos/metronic/assets/media/auth/bg1-dark.jpg'); }</style>
			<!--end::Page bg image-->
				...
				<div class="d-flex flex-column flex-center text-center p-10">
					...
					<div class="card card-flush w-lg-650px py-5">
						<div class="card-body py-15 py-lg-20">
							...
							<!--begin::Illustration-->
							<div class="mb-3">
								<img src="recursos/metronic/assets/media/auth/404-error.png" class="mw-100 mh-300px theme-light-show" alt="" />
								<img src="recursos/metronic/assets/media/auth/404-error-dark.png" class="mw-100 mh-300px theme-dark-show" alt="" />
							</div>
							<!--end::Illustration-->
							<!--begin::Link-->
							<div class="mb-0">
								<a href="/" class="btn btn-sm btn-primary">Iniciar Nuevamente</a>
							</div>
							<!--end::Link-->
						</div>
					</div>
